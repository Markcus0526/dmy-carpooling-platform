...
@interface Cus_NewsMgrViewController ()
...
@implementation Cus_NewsMgrViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Cus_NewsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"newscell"];
    if (cell == nil)
	{
		cell = (Cus_NewsTableViewCell *)[Cus_NewsTableViewCell cellFromNibNamed:@"Cus_NewsTableViewCell"];
	}

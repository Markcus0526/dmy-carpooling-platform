...
@interface Drv_BindAccountViewController : SuperViewController <UITextFieldDelegate, UITextViewDelegate, UIPickerViewDelegate, UIAlertViewDelegate, TradeSvcDelegate>
{
    /********************** UI Controls ***************************/

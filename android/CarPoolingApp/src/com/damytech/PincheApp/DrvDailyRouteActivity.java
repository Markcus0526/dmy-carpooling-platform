...
public class DrvDailyRouteActivity extends SuperActivity implements DialogInterface.OnDismissListener
{
        ...
        public void onSuccess(String content) {
            ...
            try
            {
                ...
                if (nRetcode == ConstData.ERR_CODE_NONE)
                {
                    ...
                    adapter = new ItemAdapter(DrvDailyRouteActivity.this, 0, arrDatas);
                ...
                {
                    Global.showAdvancedToast(DrvDailyRouteActivity.this, szRetmsg, Gravity.CENTER);
                }
            }
            catch (Exception ex)
            {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_driver_dailyroute);
        ...
        public void onClick(View v) {
            switch (v.getId())
            {
                case R.id.btnAddRoute:
                    Intent intent = new Intent(DrvDailyRouteActivity.this, DrvDailyRouteAddActivity.class);
                    intent.putExtra("IsUpdate", 0);
                    intent.putExtra(Global.ANIM_DIRECTION(), Global.ANIM_COVER_FROM_RIGHT());
                    DrvDailyRouteActivity.this.getIntent().putExtra(Global.ANIM_DIRECTION(), Global.ANIM_COVER_FROM_LEFT());
    ...
    public class ItemAdapter extends ArrayAdapter<STCommonRoute>
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null)
            {
                ...
                Point point = Global.getScreenSize(DrvDailyRouteActivity.this);
            ...
            lblPath.setText(list.get(position).startaddr + getResources().getString(R.string.addr_separator) + list.get(position).endaddr);
            ...
            String strDate = "";
            if (list.get(position).daytype == 1)
                strDate = getString(R.string.STR_COMMONROUTEADD_WORKDAY) + " " + list.get(position).create_time;
            else if (list.get(position).daytype == 2)
                strDate = getString(R.string.STR_COMMONROUTEADD_WEEKEND) + " " + list.get(position).create_time;
            else
                strDate = getString(R.string.STR_COMMONROUTEADD_ALLDAY) + " " + list.get(position).create_time;
	        ...
	        btnItem.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    dlgDelete = new DrvDailyRouteDeleteDialog(DrvDailyRouteActivity.this);
                    dlgDelete.setOnDismissListener(DrvDailyRouteActivity.this);

...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            PreUtils.savePushUserId(context, userId);
            PreUtils.savePushChannelId(context, channelId);
        }
            ...
            try {
                ...
                switch (typecode)
                {
                    ...
                    case ConstData.PUSH_PASS_LONG_CONFIRM:
                    {
                        ...
                        intent.putExtra("pushresult", content);
                        intent.setClass(context.getApplicationContext(), DrvMainActivity.class);
                    ...
                    case ConstData.PUSH_DRV_ORDER_DETAIL:
                    {
                        ...
                        Intent intent = new Intent();
                        intent.putExtra("pushresult", content);
                        intent.setClass(context.getApplicationContext(), PassMainActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.getApplicationContext().startActivity(intent);
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent();
                        intent.setClass(context.getApplicationContext(), LogoActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.getApplicationContext().startActivity(intent);
                        break;
                    }
                    case ConstData.PUSH_PASS_ONCE_CONFRIM:
                    {
                        Intent intent = new Intent();
                        intent.putExtra("pushresult", content);
                        intent.setClass(context.getApplicationContext(), PassOnceOrderConfirmActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.getApplicationContext().startActivity(intent);

//                        Intent intent = new Intent(Intent.ACTION_MAIN);
//                        ComponentName componentName = new ComponentName(context.getPackageName(),
//                                context.getPackageName()+".PassOnceOrderConfirmActivity");

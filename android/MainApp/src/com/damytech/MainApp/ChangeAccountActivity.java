...
public class ChangeAccountActivity extends SuperActivity
{
	...
	private void onClickBind()
	{
        ...
        if ((edt_new_account.getText().toString().length() < 16) || (edt_new_account.getText().toString().length() > 19))
        {
            Global.showAdvancedToast(ChangeAccountActivity.this, getResources().getString(R.string.STR_CHANGEACCOUNT_NEWACCOUNT_ERROR_LENGHT), Gravity.CENTER);
            edt_new_account.requestFocus();
            return;
        }

...
//	private String car_img;
	...
	private float ratio_as_passenger;
	private float integer_as_passenger;
	private int activeway_as_passenger;
	private float ratio_as_driver;
	private float integer_as_driver;
...
/*	public String getCar_img() {
	...
	public float getRatio_as_passenger() {
		return ratio_as_passenger;
	}

	public void setRatio_as_passenger(float ratio_as_passenger) {
		this.ratio_as_passenger = ratio_as_passenger;
	}

	public float getInteger_as_passenger() {
		return integer_as_passenger;
	}

	public void setInteger_as_passenger(float integer_as_passenger) {
	...
	public float getRatio_as_driver() {
		return ratio_as_driver;
	}

	public void setRatio_as_driver(float ratio_as_driver) {
		this.ratio_as_driver = ratio_as_driver;
	}

	public float getInteger_as_driver() {
		return integer_as_driver;
	}

	public void setInteger_as_driver(float integer_as_driver) {

package com.pinche.order.appointdetail.action;
...
public class OrderDetails {
	...
	private long psgerId;
	private String psgerCode;
	private String psgerName;
	private String psgerPhone;
	...
	// {1:true, 0:false} breaking Button "退还乘客1冻结的绿点" 
	...
	public String getPsgerCode() {
		return psgerCode;
	}
	public void setPsgerCode(String psgerCode) {
		this.psgerCode = psgerCode;
	}
	...
	public String getPsgerPhone() {
		return psgerPhone;
	}
	public void setPsgerPhone(String psgerPhone) {
		this.psgerPhone = psgerPhone;
	}
	...
	public long getPsgerId() {
		return psgerId;
	}
	public void setPsgerId(long psgerId) {
		this.psgerId = psgerId;
	}

...
public class Syscoupon1 {
	...
	private int releaseChannel = 0;
	private int appSpreadUnitId = 0;
	private int goodsOrCash = 0;
	private int sum = 0;
	private String goods = "";
	private int applySource = 0;
	private int couponType = 0;
	private int limit_val = 0;
	private int validPeriodUnit = 0;
	...
	public int getAppSpreadUnitId() {
		return appSpreadUnitId;
	}
	public void setAppSpreadUnitId(int appSpreadUnitId) {

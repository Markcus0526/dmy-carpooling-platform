...
import com.nmdy.spread.sms.service.SMSPlanService;


public class SMSUserAction extends ActionSupport {
   ...
   */
	 ...
	 */
	public String findUnSelectUser() {
	...
	public String deleteSMSuser(){
		...
		try{
		map.put("sms_plan_id", sms_plan_id);
		smsPlanService.updateSMSPlans(sms_plan_id);

...
public class Appoint {
	...
	private Date 	clientbeginservice_time; 
	private Date 	clientend_time;
	...
	public Date getClientbeginservice_time() {
		return clientbeginservice_time;
	}
	public void setClientbeginservice_time(Date clientbeginservice_time) {
		this.clientbeginservice_time = clientbeginservice_time;
	}
	public Date getClientend_time() {
		return clientend_time;
	}
	public void setClientend_time(Date clientend_time) {
		this.clientend_time = clientend_time;
	}

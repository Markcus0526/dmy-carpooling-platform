		...
		$.ajax({
			...
			success: function(ret) {
					if(ret.err_code == 0){					
						...
						parent.$.messager.alert('', "插入失败", 'waring');
					} 
			},
		});
	}
			...
			<div style="float: left; width: 600px">
				<table style="width: 600px">
					<tr style="height: 50px;">
						...
						<td><input id="adm_id" name="adm_id" disabled="disabled"
							Class="textbox" /></td>
					...
					<tr style="height: 50px;">
						...
						<td><input id="order_cs_id" name="order_cs_id"
							...
							Style="width: 133px;"></input> <a href="javascript:void(0)"
							onclick="searchInterface() " class="easyui-linkbutton l-btn"
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" id="status1" name="status1"
							style="border: 0px; background-color: transparent; margin-left: 10px"
				...
				<div style="margin-left: 80px">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
						onclick="processAction();" style="width: 80px;">处理</a>
					<!-- 					<input type="submit" name="submit">保存</input> -->
					<a href="javascript:void(0)" class="easyui-linkbutton"
						onclick="closeProcess();" style="width: 80px; margin-left: 50px">取消</a>
				</div>
			</div>
		</form>

...
<script>
   ...
   function view(id){
		...
		window.location=page_path + "view1.do?id="+id+"&&choose="+2 ;
   }
   function loaddone() {
	...
	<div id="orderdetails_tab">
		<div style="margin-top: 60px; margin-left: 35px">
			...
			<select id="order_type" name="order_type" disabled="disabled"
				...
				<option value="1">上下班拼车</option>
				<option value="1">长途拼车</option>
		...
		<div style="margin-top: 10px; margin-left: 35px">
			...
			<span style="margin-left: 31px">开始执行:</span> <input
				id="begin_exec_time" name="begin_exec_time" disabled="disabled"
				Class="textbox _textbox" style="width: 150px">
			<%} %>
		</div>
		<% if(request.getAttribute("order_type")==(Integer)1){ %>
		<div style="margin-top: 10px; margin-left: 18px">
			<span>乘客已上车:</span> <input id="isCatchedCar1" type="radio"
				name="isCatchedCar" disabled="disabled" value="1">是<input
				id="isCatchedCar2" type="radio" name="isCatchedCar"
				...
				type="radio" name="isPayed" value="1" disabled="disabled">是<input
				id="isPayed2" type="radio" name="isPayed" disabled="disabled"
		...
		<div style="margin-top: 20px; margin-left: 35px; margin-bottom: 25px">
			...
			<span>需求车型:</span> <select id="reqcarstyle" name="reqcarstyle"
				...
				style="width: 150px" />
			<%} %>
			<span <% if(request.getAttribute("order_type")!=(Integer)3){ %>
				style="margin-left: 33px" <%} %>>车主备注: </span> <input
				id="driyerremark" name="driyerremark" disabled="disabled"
				Class="textbox _textbox" style="width: 150px">
		...
		<div style="margin-left: 40px; margin-bottom: 25px">
			上下班订单出行日: <input id="weekdays_1" name="weekdays_1"
				disabled="disabled" style="margin-left: 30px" type="checkbox"
				value="1"><span>周一</span> <input id="weekdays_2"
				name="weekdays_2" disabled="disabled" style="margin-left: 30px"
				type="checkbox" value="2"><span>周二</span> <input
				id="weekdays_3" name="weekdays_3" disabled="disabled"
				style="margin-left: 25px" type="checkbox" value="3"><span>周三</span>
			<input id="weekdays_4" name="weekdays_4" disabled="disabled"
				style="margin-left: 25px" type="checkbox" value="4"><span>周四</span>
			<input id="weekdays_5" name="weekdays_5" disabled="disabled"
				style="margin-left: 25px" type="checkbox" value="5"><span>周五</span>
			<input id="weekdays_6" name="weekdays_6" disabled="disabled"
				style="margin-left: 25px" type="checkbox" value="6"><span>周六</span>
			<input id="weekdays_7" name="weekdays_7" disabled="disabled"
				style="margin-left: 25px" type="checkbox" value="0"><span>周日</span>
		</div>
		<%} %>

	...
	datagrid=$('#dg').datagrid({		
							...
							columns : [ [
									...
									//checkbox : true
										...
										var str = '';
  										str += '<a href="customer/showUI.do?id='+row.id+'" onclick="showFLDG()">查看详情</a> &nbsp';
  											return str;
...
<body onload="loaddone()">
	<div id="tt" class="easyui-tabs" style="width: 720px; height: auto;"
		border="true">
		<div title="客户基本信息"
	...
	<a id="cancelGroup" href="javascript:void(0)" class="easyui-linkbutton"
		onclick="javascript:history.go(-1);" iconcls="icon-cancel"
		style="float: true">返&nbsp;回</a>
</body>
</html>

...
$(function(){
	...
	$('#dg').datagrid({		
							url	:'<%=basePath%>customer/findASUAllRebateListInfo.do?id=${id}',
	...
	function showFLDG(id) {
		...
		$('#rebateForm').datagrid({		
							...
							url	:'<%=basePath%>customer/findASURebateListInfo.do?id='+id,
							method : 'POST',
							title : '返利列表',
							iconCls : 'icon-save',
							pagination : true,
		...
		<table border=0>
			<tr>
				...
				<td align=right style="width: 100px; height: 15px;"><input
					id="unit_id" name="unit_id" readOnly="readonly"></td>
				<td>邀请码：</td>
				<td align=right style="width: 100px; height: 15px;"><input
					id="invite_code" name="invite_code" readOnly="readonly"></td>
			</tr>
			<tr>
				<td>客户名称：</td>

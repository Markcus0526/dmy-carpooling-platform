...
@interface Cus_NewsMgrViewController : SuperViewController<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, MainSvcDelegate, Cus_NewsCellDelegate>
{
    /********************** UI Controls **********************/

...
@interface NewsMgrVC : SuperViewController<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, MainSvcDelegate, NewsCellDelegate>
{
	/********************** UI Controls **********************/
	...
	__weak IBOutlet UIView *_vwTabView;

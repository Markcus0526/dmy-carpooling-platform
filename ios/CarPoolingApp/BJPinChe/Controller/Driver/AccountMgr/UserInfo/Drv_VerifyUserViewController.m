...
#import "Drv_VerifyUserViewController.h"
#import "RDActionSheet.h"
#import "NonRotateImagePickerController.h"
#import "ImageHelper.h"

@interface Drv_VerifyUserViewController ()

@end

@implementation Drv_VerifyUserViewController
...
- (IBAction)onClickedConfirm:(id)sender
{
    if (mBmpFrontPhoto == nil || mBmpBackPhoto == nil) {
        [self.view makeToast:MSG_SELECT_IMAGE duration:DEF_DELAY position:@"center"];
        return;
    }

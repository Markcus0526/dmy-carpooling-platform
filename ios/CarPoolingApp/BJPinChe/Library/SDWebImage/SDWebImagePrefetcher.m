...
- (void)reportStatus
{
	...
	NSLog(@"Finished prefetching (%d successful, %lu skipped, timeElasped %.2f)", (int)(total - _skippedCount), (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}

...
public class SVCGlobalParams {
	...
	public static SVCGlobalParams decodeFromJSON(JSONObject jsonObj)
	{
		if (jsonObj == null)
			return null;

		SVCGlobalParams city = new SVCGlobalParams();
	...
	public static SVCGlobalParams decodeFromResultSet(ResultSet resultSet)
	{
		if (resultSet == null)
			return null;

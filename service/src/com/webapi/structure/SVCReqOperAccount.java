...
public class SVCReqOperAccount {
	public long id = 0;
	...
	public static SVCReqOperAccount decodeFromJSON(JSONObject jsonObj)
	{
		if (jsonObj == null)
			return null;

		SVCReqOperAccount req_info = new SVCReqOperAccount();
	...
	public static SVCReqOperAccount decodeFromResultSet(ResultSet resultSet)
	{
		if (resultSet == null)
			return null;
